      ...
      <div onClick={(e) => e.stopPropagation()} className="w-full max-w-[720px] max-h-[80vh] flex flex-col bg-[#0a0a0b] border border-bord rounded-[18px] overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,.6)]">
        <header className="flex items-center justify-between gap-4 px-5 py-4 border-b border-trait">
          <div className="min-w-0">
            ...
            <p className="m-0 mt-0.5 text-[12.5px] text-brume">
        ...
        {!compte ? (
          <p className="m-0 px-5 py-8 text-[13.5px] text-ardoise">Aucun compte Google avec accès Drive n'est connecté. Connectez-en un depuis le dashboard, en accordant l'accès Drive.</p>
        ) : (
          <>
            ...
            <div className="flex-1 overflow-y-auto">
              {isLoading ? (
                ...
                <p className="m-0 px-5 py-8 text-[13.5px] text-brume">Aucun fichier ici.</p>
              ) : (
                fichiers.map((f) => {
