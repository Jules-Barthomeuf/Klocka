  ...
  theme: {
  	extend: {
  		...
  		colors: {
			...
			'rapport-bleu': 'rgb(var(--k-rapport-bleu-rgb) / <alpha-value>)',
			'rapport-orange': 'rgb(var(--k-rapport-orange-rgb) / <alpha-value>)',
			'rapport-sur-bleu': 'rgb(var(--k-rapport-sur-bleu-rgb) / <alpha-value>)',
