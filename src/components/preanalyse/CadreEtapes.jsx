        ...
        <div className="flex flex-wrap items-center gap-5">
          ...
          {progression && (
            <div className="flex items-center gap-3 flex-none">
              <div className="w-[120px] h-px bg-bord-doux relative"><div className="absolute left-0 top-[-1px] h-[3px] bg-encre" style={{ width: `${part}%` }} /></div>
              <Mono className="text-ardoise">{progression.lus} / {progression.total} docs</Mono>
            </div>
          )}
        </div>
      </header>
