  ...
  return (
    <div className="bg-[#000000] p-4 rounded-md md:p-6 border border-[#f2f3f5]/[0.1] max-w-full overflow-hidden">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-3 md:mb-4 gap-1">
        <h3 className="font-light text-[#f2f3f5] text-xl md:text-2xl tracking-tight">Revenus locatifs prévisionnels</h3>
        <span className={`text-xs ${mutedClass}`}>sur {anneeRevente} ans</span>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 w-full">
        <div className="flex items-center justify-between p-2 md:p-3 bg-[#f2f3f5]/[0.04] rounded-lg border border-[#1f2228] md:block">
