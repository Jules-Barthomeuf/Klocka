...
export const fieldWrap = "bg-[#171A21] border border-white/[0.08] rounded-[14px] px-[18px] py-3.5 transition-all focus-within:border-[#2A9D8F] focus-within:shadow-[0_0_0_3px_rgba(42,157,143,0.14)]";
