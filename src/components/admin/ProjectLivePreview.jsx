...
function Shell({ children, formData }) {
  return (
    <div className="bg-[#12151C] border border-trait rounded-[18px] overflow-hidden max-w-[360px] shadow-[0_24px_50px_rgba(0,0,0,0.5)]">
      <div
...
export default function ProjectLivePreview({ activeTab, formData }) {
  ...
  return (
    <div>
      <p className="text-[11px] uppercase tracking-[0.18em] text-brume mb-3 font-semibold">{label}</p>
