...
function Title({ children }) {
  return <h2 className="text-2xl md:text-4xl font-extrabold mb-4 text-center leading-tight uppercase tracking-wide text-white">{children}</h2>;
}
    ...
    <div>
      ...
      <section className="bg-[#050807] text-white">
        ...
        <div className="max-w-3xl mx-auto mb-12 text-center">
          <p className="text-white text-2xl md:text-3xl font-extrabold leading-tight mb-2">
                    ...
                    {isHighlight ? (
                      <div className="p-6 md:p-8 relative">
                        <div className="absolute top-4 right-4">
                          <span className="text-[10px] font-bold uppercase tracking-wider text-amber-400 bg-amber-400/10 border border-amber-400/30 rounded-full px-3 py-1">⭐ Étape clé</span>
                        </div>
                        <div className="flex flex-col md:flex-row md:items-center gap-6">
                          ...
                          <div className="flex-1">
                            <span className="text-amber-400/60 text-xs font-mono font-bold block mb-1">Étape {s.num}</span>
                            ...
                            <div className="mt-5 inline-flex items-center gap-2 bg-amber-400/10 border border-amber-400/25 rounded-full px-5 py-2">
                              <span className="text-amber-400 text-sm font-bold">✨ 3 deals inclus — différenciateur clé de l'accompagnement</span>
                            </div>
                          </div>
                        </div>
                      </div>
