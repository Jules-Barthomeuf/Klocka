...
export default function EconomieSection({ data }) {
  const secteursData = [
    data.pct_etab_commerce_services > 0 && { name: "Commerce/Services", value: data.pct_etab_commerce_services, color: "#35a79b" },
    data.pct_etab_admin_public > 0 && { name: "Admin publique", value: data.pct_etab_admin_public, color: "#7fd3c9" },
    data.pct_etab_construction > 0 && { name: "Construction", value: data.pct_etab_construction, color: "#2f8d84" },
  ...
  const tailleData = [
    data.pct_etab_0_salarie > 0 && { name: "0 salarié", value: data.pct_etab_0_salarie, color: "#7fd3c9" },
    data.pct_etab_1_9 > 0 && { name: "1-9 sal.", value: data.pct_etab_1_9, color: "#35a79b" },
  ...
  return (
    <SectionCard icon={<Building2 className="w-5 h-5 text-[#35a79b]" />} title="Tissu Économique">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {secteursData.length > 0 && (
          <div>
            <p className="text-sm text-[#9aa19e] mb-3">Répartition par secteur</p>
        ...
        {tailleData.length > 0 && (
          <div>
            <p className="text-sm text-[#9aa19e] mb-3">Taille des établissements</p>
            <div className="space-y-2">
