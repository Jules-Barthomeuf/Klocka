...
export default function AssistantExterne() {
  ...
  return (
    <div className="h-screen bg-[#000000] flex flex-col items-center justify-center text-center px-6">
      <Loader2 className="w-8 h-8 text-[#2A9D8F] animate-spin mb-6" />
      ...
      <a
        href={ASSISTANT_URL}
        className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#2A9D8F]/15 border border-[#2A9D8F]/30 hover:bg-[#2A9D8F]/25 text-white text-sm transition-colors"
      >
