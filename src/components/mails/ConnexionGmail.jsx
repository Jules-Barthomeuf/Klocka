...
export function EncartConnexionGmail({ onConnecte, googleConfigure = true }) {
  if (!googleConfigure) {
    return (
      <div className="rounded-md border border-menthe/25 bg-menthe/[0.07] px-4 py-3">
  ...
  return (
    <div className="rounded-md border border-trait bg-encre/[0.02] px-4 py-3 flex flex-wrap items-center gap-3">
      <p className="text-ardoise text-xs flex-1 min-w-48 leading-relaxed">
