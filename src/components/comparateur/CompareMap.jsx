...
export default function CompareMap({ metrics }) {
    ...
    return (
      <div className="bg-fond rounded-md border border-trait p-5">
        <div className="flex items-center mb-4">
          <p className="text-encre/40 text-xs uppercase tracking-[0.15em]">
        ...
        <div className="flex flex-col items-center justify-center h-48 text-encre/20">
  ...
  if (loading && projectsWithCoords.length === 0) {
    return (
      <div className="bg-fond rounded-md border border-trait p-5">
        <div className="flex items-center mb-4">
          <p className="text-encre/40 text-xs uppercase tracking-[0.15em]">Localisation des projets</p>
        </div>
        <div className="flex items-center justify-center h-48 text-encre/30">
            ...
            return (
              <Marker key={m.id} position={[m.lat, m.lng]} icon={icon}>
                <Popup>
                  ...
                  <div className="text-xs text-ardoise">{m.adresse || ""}</div>
                </Popup>
              </Marker>
            );
          })}
