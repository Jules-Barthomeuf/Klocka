...
export const GABARIT_MURS = {
  ...
  colonnes: [
    ...
    { id: 'amiante', bloc: 'Bien', libelle: 'Amiante', question: "Diagnostic amiante : présence ou absence, localisation des matériaux, niveau (évaluation périodique, niveau 1, 2 ou 3), date", regle: 'information', criticite: 'haute' },
    { id: 'erp', bloc: 'Bien', libelle: 'ERP', question: "État des risques et pollutions : risques recensés (inondation, sismicité, radon, pollution des sols), date", regle: 'information', criticite: 'basse' },
    { id: 'termites', bloc: 'Bien', libelle: 'Termites', question: 'Diagnostic termites : présence ou absence, date', regle: 'information', criticite: 'moyenne' },
    { id: 'plomb', bloc: 'Bien', libelle: 'Plomb', question: 'Diagnostic plomb (CREP) : présence ou absence, date', regle: 'information', criticite: 'moyenne' },
    { id: 'electricite', bloc: 'Bien', libelle: 'Électricité', question: "Diagnostic électrique : date du rapport, conformité ou anomalies relevées", regle: 'information', criticite: 'moyenne' },
    { id: 'provision_charges', bloc: 'Bail', libelle: 'Provision pour charges', question: 'Provision pour charges et taxes appelée avec le loyer (montant, périodicité), dans le bail ou sur les quittances', regle: 'information', criticite: 'moyenne' },
    ...
    { id: 'travaux_discussion', bloc: 'Copropriété', libelle: 'Travaux en discussion', question: 'Travaux évoqués ou en discussion en assemblée mais non votés, reportés ou ajournés (nature, montant estimé, échéance)', regle: 'information', criticite: 'haute' },
    { id: 'resolutions_non_votees', bloc: 'Copropriété', libelle: 'Résolutions non votées', question: "Résolutions rejetées, non votées ou reportées d'une assemblée à l'autre, et si elles reviennent de façon récurrente", regle: 'information', criticite: 'moyenne' },
    { id: 'impayes_copro', bloc: 'Copropriété', libelle: 'Impayés de copropriété', question: 'Impayés de charges dans la copropriété : montant total, copropriétaires débiteurs, procédures de recouvrement', regle: 'information', criticite: 'haute' },
    { id: 'activites_autorisees', bloc: 'Copropriété', libelle: 'Activités autorisées', question: 'Activités autorisées par le règlement de copropriété pour les lots commerciaux (destination des lots)', regle: 'information', criticite: 'moyenne' },
    { id: 'activites_interdites', bloc: 'Copropriété', libelle: 'Activités interdites', question: 'Activités interdites ou restreintes par le règlement de copropriété (nuisances, horaires, enseignes, odeurs, bruit)', regle: 'information', criticite: 'haute' },
    { id: 'quote_part', bloc: 'Copropriété', libelle: 'Quote-part', question: 'Quote-part du ou des lots dans les charges générales : tantièmes sur le total, et pourcentage', regle: 'information', criticite: 'moyenne' },
