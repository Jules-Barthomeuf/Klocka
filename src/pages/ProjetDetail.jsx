...
export default function ProjetDetail() {
  ...
  return (
    <>
      <AnimatePresence>
        {showDoorAnimation && (
          <motion.div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black" initial={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: 0.5, delay: 1.5 }}>
            <motion.div className="absolute top-0 left-0 h-full w-1/2 bg-black border-r border-[#2A9D8F]/30" initial={{ x: 0 }} animate={{ x: "-100%" }} transition={{ duration: 0.8, delay: 1, ease: "easeInOut" }} />
            <motion.div className="absolute top-0 right-0 h-full w-1/2 bg-black border-l border-[#2A9D8F]/30" initial={{ x: 0 }} animate={{ x: "100%" }} transition={{ duration: 0.8, delay: 1, ease: "easeInOut" }} />
