...
export default function ProjectFormSwotTab({ formData, setFormData }) {
  ...
  return (
    <div className="mt-6 space-y-6">
      ...
      <div className="p-5 bg-white/[0.015] rounded-xl border border-white/[0.05] space-y-3">
        ...
        <VerificationField fieldKey="swot_texte_general" formData={formData} setFormData={setFormData}>
          <Textarea
            ...
            className="bg-[#161616] text-white border-white/[0.08]"
          />
        </VerificationField>
      </div>

      {/* Indicateurs structurés */}
      <div className="p-5 bg-white/[0.015] rounded-xl border border-white/[0.05] space-y-5">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="space-y-3 p-4 bg-white/[0.02] rounded-xl border border-white/[0.06]">
            <p className="text-[#2A9D8F] text-xs font-semibold uppercase tracking-wider">Politique & Gouvernance</p>
            <VerificationField fieldKey="swot_maire" formData={formData} setFormData={setFormData}>
              <div>
                ...
                <Input value={swot.maire || ""} onChange={(e) => update("maire", e.target.value)} placeholder="Ex: Martine Aubry" className="bg-[#161616] text-white border-white/[0.08] mt-1" />
              </div>
            </VerificationField>
            <VerificationField fieldKey="swot_parti_politique" formData={formData} setFormData={setFormData}>
              <div>
                ...
                <Input value={swot.parti_politique || ""} onChange={(e) => update("parti_politique", e.target.value)} placeholder="Ex: PS" className="bg-[#161616] text-white border-white/[0.08] mt-1" />
              </div>
            </VerificationField>
            <VerificationField fieldKey="swot_politiques_cles" formData={formData} setFormData={setFormData}>
              <div>
                ...
                <Textarea value={swot.politiques_cles || ""} onChange={(e) => update("politiques_cles", e.target.value)} rows={2} placeholder="Ex: Redynamisation centre-ville, ZFE..." className="bg-[#161616] text-white border-white/[0.08] mt-1" />
              </div>
            </VerificationField>
          </div>
          ...
          <div className="space-y-3 p-4 bg-white/[0.02] rounded-xl border border-white/[0.06]">
            ...
            <VerificationField fieldKey="swot_projets_ville" formData={formData} setFormData={setFormData}>
              <div>
                ...
                <Textarea value={swot.projets_ville || ""} onChange={(e) => update("projets_ville", e.target.value)} rows={3} placeholder="Ex: Nouveau tramway, rénovation quartier gare..." className="bg-[#161616] text-white border-white/[0.08] mt-1" />
              </div>
            </VerificationField>
            <VerificationField fieldKey="swot_programmes_nationaux" formData={formData} setFormData={setFormData}>
              <div>
                ...
                <Textarea value={swot.programmes_nationaux || ""} onChange={(e) => update("programmes_nationaux", e.target.value)} rows={2} placeholder="Ex: Action Cœur de Ville, Petites Villes de Demain..." className="bg-[#161616] text-white border-white/[0.08] mt-1" />
              </div>
            </VerificationField>
          </div>
          ...
          <div className="space-y-3 p-4 bg-white/[0.02] rounded-xl border border-white/[0.06]">
            ...
            <VerificationField fieldKey="swot_taux_pauvrete" formData={formData} setFormData={setFormData}>
              <div>
                ...
                <Input type="number" value={swot.taux_pauvrete ?? ""} onChange={(e) => update("taux_pauvrete", e.target.value ? parseFloat(e.target.value) : null)} placeholder="Ex: 18.5" className="bg-[#161616] text-white border-white/[0.08] mt-1" />
              </div>
            </VerificationField>
            <VerificationField fieldKey="swot_taux_etudiants" formData={formData} setFormData={setFormData}>
              <div>
                ...
                <Input type="number" value={swot.taux_etudiants ?? ""} onChange={(e) => update("taux_etudiants", e.target.value ? parseFloat(e.target.value) : null)} placeholder="Ex: 12.3" className="bg-[#161616] text-white border-white/[0.08] mt-1" />
              </div>
            </VerificationField>
            <VerificationField fieldKey="swot_risques_environnement" formData={formData} setFormData={setFormData}>
              <div>
                ...
                <Textarea value={swot.risques_environnement || ""} onChange={(e) => update("risques_environnement", e.target.value)} rows={2} placeholder="Ex: Zone inondable, pollution sols..." className="bg-[#161616] text-white border-white/[0.08] mt-1" />
              </div>
            </VerificationField>
          </div>
          ...
          <div className="space-y-3 p-4 bg-white/[0.02] rounded-xl border border-white/[0.06]">
            ...
            <VerificationField fieldKey="swot_score_global" formData={formData} setFormData={setFormData}>
              <div>
                ...
                <Input type="number" value={swot.score_global ?? ""} onChange={(e) => update("score_global", e.target.value ? parseFloat(e.target.value) : null)} placeholder="Ex: 72" className="bg-[#161616] text-white border-white/[0.08] mt-1" />
              </div>
            </VerificationField>
          </div>
        </div>
      ...
      {/* Liens sources */}
      <div className="p-5 bg-white/[0.015] rounded-xl border border-white/[0.05] space-y-3">
        <Label className="text-white text-lg">Liens sources</Label>
        {liens.map((l, i) => (
          <div key={i} className="flex gap-2">
            <Input value={l.label || ""} onChange={(e) => { const n = [...liens]; n[i] = { ...n[i], label: e.target.value }; updateLiens(n); }} placeholder="Label" className="bg-[#161616] text-white border-white/[0.08] w-1/3" />
            <Input value={l.url || ""} onChange={(e) => { const n = [...liens]; n[i] = { ...n[i], url: e.target.value }; updateLiens(n); }} placeholder="URL" className="bg-[#161616] text-white border-white/[0.08] flex-1" />
        ...
        <Button variant="outline" size="sm" onClick={() => updateLiens([...liens, { label: "", url: "" }])} className="border-white/[0.06] text-white/30 hover:text-white">
