...
export default function BoutonMonday({ dealId, projetId, dejaPose = false, className = "" }) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-2 px-4 h-10 rounded-[10px] border border-bord-doux text-[14px] text-craie hover:text-encre hover:border-bord-vif disabled:opacity-50 transition-colors ${className}`}
    >
