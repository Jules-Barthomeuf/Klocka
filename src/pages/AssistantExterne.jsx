...
export default function AssistantExterne() {
  ...
  return (
    <div className="h-screen bg-[#000000] flex flex-col items-center justify-center text-center px-6">
      <Loader2 className="w-8 h-8 text-[#96c0b8] animate-spin mb-6" />
      ...
      <a
        href={ASSISTANT_URL}
        className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#96c0b8]/15 border border-[#96c0b8]/30 hover:bg-[#96c0b8]/25 text-[#f2f3f5] text-sm transition-colors"
      >
