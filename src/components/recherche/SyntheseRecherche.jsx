  ...
  return (
    <div className="bg-white/[0.015] rounded-2xl border border-white/[0.06] overflow-hidden">
      ...
      <div className="px-5 py-4 border-b border-white/[0.06]" style={{ backgroundColor: `${color}10` }}>
        ...
        <p className="text-white text-sm font-medium leading-snug">{titre}</p>
      </div>
      ...
      <div className="px-5 py-4 space-y-5">
        ...
        {sections.map((section, sIdx) => (
          <div key={sIdx}>
            <div className="flex items-center gap-2 mb-2.5">
              ...
              <p className="text-[9px] uppercase tracking-[0.15em] text-white/40 font-medium">{section.titre}</p>
            </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-2.5">
            ...
            <p className="text-[9px] uppercase tracking-[0.15em] text-white/40 font-medium">Rendements cibles</p>
          </div>
          <div className="space-y-2">
        ...
        {typesCommerceExclus && typesCommerceExclus.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-2.5">
              ...
              <p className="text-[9px] uppercase tracking-[0.15em] text-white/40 font-medium">Exclusions</p>
            </div>
      ...
      <div className="bg-white/[0.015] rounded-2xl border border-white/[0.06] p-5">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-white/30 text-xs">Critères de recherche par tranche de budget — toutes catégories</p>
          </div>
        </div>
      </div>
