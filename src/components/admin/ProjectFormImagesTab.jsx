      ...
      <div className="space-y-4">
        <div className="p-6 bg-surface rounded-none border border-trait">
          ...
          <label className="cursor-pointer">
            ...
            <Button type="button" disabled={uploading} className="w-full bg-encre/[0.06] border border-bord-doux hover:bg-encre/[0.1] text-encre" asChild>
                ...
                <div
                  ...
                  className={`relative group transition-all duration-150 ${
                    dragOverIdx === idx && dragIdx.current !== idx
                      ? 'scale-105 ring-2 ring-menthe'
                      : ''
                  }`}
                  style={{ cursor: 'grab' }}
                >
                  <div className="relative rounded-lg border border-trait overflow-hidden bg-encre/[0.02] h-36">
                    <img
                      src={url}
                      alt={`Photo ${idx + 1}`}
