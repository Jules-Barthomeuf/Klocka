...
function AnimatedStatCard({ icon: Icon, title, value, suffix, description, delay = 0 }) {
  ...
  return (
    <motion.div
      ...
      className="border-t border-encre/[0.35] pt-6 pb-2">
...
export default function Vision() {
  ...
  if (hasError) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-fond text-encre">
  ...
  return (
    <div
      className="min-h-screen bg-fond text-encre">
              ...
              className="mb-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-6 max-md:gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    variant="outline"
                    size="icon"
                    className="h-10 w-10 bg-fond/50 border-trait text-encre hover:bg-fond disabled:opacity-30">
                    ...
                    <div className="text-sm text-ardoise font-normal">
                      {currentSlide + 1} / 6
                    </div>
                    <Button
                  ...
                  className="space-y-12">
                      ...
                      <div className="text-center">
                        <h2 className="text-[38px] md:text-[50px] font-light tracking-[-0.02em] leading-[1.08] mb-4">
                          <span className="text-encre">Vue d'ensemble</span><br />
                          <span className="text-menthe font-light">Votre stratégie en chiffres</span>
                        </h2>
                      </div>
                    ...
                    className="py-2 pl-6 border-l-2 border-menthe max-w-4xl mx-auto">

                        <p className="text-encre font-normal text-base leading-relaxed">
                          {(() => {
        ...
        <motion.div
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-1">
              <Label className="text-lg text-encre font-normal font-semibold flex items-center gap-2">
                Objectif mensuel souhaité
              </Label>
              <p className="text-xs text-ardoise font-normal">Revenus nets après crédit et charges</p>
            </div>
              ...
              <div className="grid grid-cols-4 gap-2">
                {['2000', '3000', '5000', '10000'].map((val) =>
                              <button
                                ...
                                revenusMensuels === val ?
                                'bg-menthe border-menthe text-encre shadow-[0_0_15px_rgba(42,157,143,0.4)]' :
                                'bg-fond/50 border-trait text-ardoise hover:border-brume'}`
                                }>
        ...
        <ProjectTimeline
                  ...
                  className="space-y-8">
                      ...
                      <div className="grid lg:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                          <div className="relative h-fit rounded-[1.25rem] border-[0.75px] border-bord p-2 md:rounded-[1.5rem] md:p-3">
                            <div className="relative bg-surface border border-encre/[0.12] p-6">
                          ...
                          <div className="relative h-fit rounded-[1.25rem] border-[0.75px] border-bord p-2 md:rounded-[1.5rem] md:p-3">
                            <div className="relative bg-surface border border-encre/[0.12] p-6">
                              <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-lg text-encre font-medium">Évolution du patrimoine financier et immobilier</h3>
                              </div>
                              <p className="text-encre text-sm font-normal leading-relaxed mb-6">
                                Construction progressive de votre richesse immobilière sur 30 ans.
                              </p>
                              <div className="space-y-3">
                                <div className="p-3 rounded-lg bg-fond/50 border border-trait">
                                  <div className="flex items-center gap-2 mb-2">
                                    <div className="w-3 h-3 rounded-full bg-menthe"></div>
                                    <span className="text-xs text-encre font-normal">Patrimoine net</span>
                                  </div>
                                  <p className="text-xs text-encre font-normal leading-relaxed">
                                ...
                                <div className="p-3 rounded-lg bg-fond/50 border border-trait">
                                  <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-xs text-encre font-normal">Dette restante</span>
                                  </div>
                                  <p className="text-xs text-encre font-normal leading-relaxed">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="relative h-fit rounded-[1.25rem] border-[0.75px] border-bord p-2 md:rounded-[1.5rem] md:p-3">
                            <div className="relative bg-surface border border-encre/[0.12] p-6">
                              <div className="flex items-center gap-3 mb-4">
                                <Wallet className="w-4 h-4 text-menthe-clair" />
                                <h3 className="text-lg text-encre font-medium">Revenus locatifs nets</h3>
                              </div>
                              <p className="text-encre text-sm font-normal leading-relaxed mb-6">
                              ...
                              <div className="space-y-3">
                                <div className="p-3 rounded-lg bg-fond/50 border border-trait">
                                  <div className="flex items-center gap-2 mb-2">
                                    <div className="w-3 h-3 rounded-full bg-menthe"></div>
                                    <span className="text-xs text-encre font-normal">Phase 1-20 • Construction</span>
                                  </div>
                                  <p className="text-xs text-encre font-normal leading-relaxed">
                                ...
                                <div className="p-3 rounded-lg bg-fond/50 border border-trait">
                                  <div className="flex items-center gap-2 mb-2">
                                    <div className="w-3 h-3 rounded-full bg-menthe-clair"></div>
                                    <span className="text-xs text-encre font-normal">Phase 20-30 • Liberté</span>
                                  </div>
                                  <p className="text-xs text-encre font-normal leading-relaxed">
                  ...
                  className="space-y-8">
                      ...
                      <div>
                        <div className="flex justify-between items-center mb-4">
                          <h3 className="text-2xl text-encre font-normal font-semibold">Vos projets immobiliers</h3>
                          <div className="flex items-center gap-2">
                            <span className="text-ardoise text-sm font-normal">{currentProjIndex + 1} / {projets.length}</span>
                            {projets.length > 1 && (
                              <>
                                <Button
                                  variant="ghost"
                                  ...
                                  className="text-encre hover:bg-encre/10 h-8 w-8"
                                >
                        ...
                        <div className="bg-fond p-2 rounded-[1.25rem] relative border-[0.75px] border-bord md:rounded-[1.5rem] md:p-3">
                          <Card className="relative bg-gradient-to-br from-fond/95 via-menthe/5 to-fond/95 overflow-hidden h-[320px] border-none">
                            <CardContent className="p-0 h-full">
                              <div className="h-full p-8 flex flex-col justify-center">
                                <div className="mb-6">
                                  <div className="text-xs text-menthe font-bold uppercase mb-2 font-normal">
                                    Année {currentProjIndex * frequence + 1}
                                  </div>
                                  <div className="text-5xl font-bold text-encre mb-4 font-light">
                                    {projets[currentProjIndex].taille >= 1000 ? `${projets[currentProjIndex].taille / 1000}M€` : `${projets[currentProjIndex].taille}K€`}
                                  </div>
                                </div>
                                
                                <div className="grid grid-cols-2 gap-4">
                                  <div className="bg-fond p-5 rounded-lg border border-menthe/30">
                                    <p className="text-ardoise text-xs mb-2 font-normal">Apport nécessaire</p>
                                    <p className="text-[#ffe98a] text-2xl font-light">
                                      {Math.round(apportData[projets[currentProjIndex].taille] / 1000)}K€
                                    </p>
                                  </div>
                                  
                                  <div className="bg-menthe-clair/10 rounded-lg p-5 border border-menthe-clair/30">
                                    <p className="text-ardoise text-xs mb-2 font-normal">Stratégie</p>
                                    <p className="text-encre text-2xl font-light">
                  ...
                  transition={{ duration: 0.4 }}>
                      ...
                      <div className="relative h-fit rounded-[1.25rem] border-[0.75px] border-bord p-2 md:rounded-[1.5rem] md:p-3">
                        <div className="relative bg-surface border border-encre/[0.12] p-6">
                          ...
                          />
                          <p className="text-encre text-sm font-normal text-center mt-4">
                          ...
                          <div className="grid md:grid-cols-2 gap-4 mt-6">
                            <div className="p-4 rounded-lg bg-fond/50 border border-menthe-clair/30">
                              <div className="flex items-center gap-2 mb-2">
                                <div className="px-2 py-1 rounded-full bg-menthe text-encre text-xs font-bold">
                                  {(resultat.chartData[9].patrimoine / resultat.apportTotal).toFixed(1)}x
                                </div>
                                <span className="text-xs text-encre font-normal">An 10</span>
                              </div>
                            ...
                            <div className="p-4 rounded-lg bg-fond/50 border border-menthe-clair/30">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-xs text-encre font-normal">An 20</span>
                              </div>
                              <p className="text-xs text-encre/70">
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.4 }}>
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      className="relative bg-surface border border-encre/[0.12]">
                       
                        <div className="p-6 border-b border-trait bg-encre/5"> 
                          <div className="flex items-center gap-2"> 
                            <BarChart3 className="text-menthe-clair lucide lucide-chart-column w-5 h-5" /> 
                            <h3 className="text-lg text-encre font-medium">Détail par année</h3> 
                          </div> 
                        </div> 
                        ...
                        <div className="overflow-x-auto"> 
                          <table className="w-full text-sm"> 
                            <thead> 
                              <tr className="border-b text-xs uppercase tracking-wider border-trait bg-encre/5"> 
                                <th className="text-left py-4 px-6 text-ardoise">Année</th> 
                                <th className="text-right py-4 px-6 text-ardoise">Patrimoine net</th> 
                                <th className="text-right py-4 px-6 text-ardoise">Cashflow annuel</th> 
                                <th className="text-right py-4 px-6 text-ardoise">Capital restant</th> 
                              </tr> 
                            </thead> 
                            ...
                            <React.Fragment key={`${resultat.apportTotal}-${index}`}> 
                                ...
                                onClick={() => row.detailsProjets.length > 0 && toggleYearExpansion(row.annee)}>
                                    ...
                                    <td className="py-4 px-6 text-right text-encre"> 
                                    ...
                                    <td className="py-4 px-6 text-right text-craie"> 
                                ...
                                <motion.tr
                                  ...
                                  exit={{ opacity: 0, height: 0 }}>
                                        ...
                                        <td colSpan="4" className="bg-encre/[0.02] px-6 py-0">
                                          <div className="border-l-2 border-[#00FFD1]/30 ml-2 my-2">
                                            {row.detailsProjets.map((detail, dIdx) =>
                                      <div key={dIdx} className="grid grid-cols-4 py-2 pl-4 text-[11px] text-ardoise">
              ...
              <motion.div
                ...
                <p className="text-encre text-base font-normal leading-relaxed text-center">
              ...
              <motion.div
                ...
                <div className="relative bg-surface border border-encre/[0.12] p-6 pt-10">
                  {/* Question revenus mensuels souhaités */}
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.3 }}
                    className="mb-6 p-4 rounded-lg bg-gradient-to-br from-menthe/10 to-black/30 border border-menthe/30">

                    <Label className="text-sm text-encre mb-3 block font-medium">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-3">
                      ...
                      <button
                        ...
                        'bg-menthe border-menthe text-encre' :
                        'bg-fond/30 border-trait text-ardoise hover:border-bord'}`
                        }>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full h-9 px-3 pr-12 rounded-lg bg-fond/50 border-2 border-trait hover:border-menthe focus:border-menthe text-encre font-normal text-xs transition-colors outline-none" />

                      <span className="absolute right-3 top-1/2 -translate-y-1/2 text-ardoise font-normal text-xs">€/mois</span>
                    </div>
                  </motion.div>
                ...
                <div className="relative h-fit rounded-[1.5rem] border border-trait bg-surface backdrop-blur-md overflow-hidden">
                  <div className="p-6 border-b border-trait bg-fond">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-lg text-encre font-medium">Investissement vs Patrimoine</h3>
                    </div>
                  </div>
                  <div className="p-6">
              ...
              <motion.div
                ...
                <h3 className="text-2xl text-encre font-normal font-semibold mb-8">Analyse détaillée</h3>
                  ...
                  <motion.div
                    ...
                    <div className="relative bg-surface border border-encre/[0.12] p-6">
                      <motion.div
                        ...
                        <TrendingUp className="w-4 h-4 text-menthe" />
                        <h3 className="text-lg text-encre font-medium">Évolution du patrimoine</h3>
                      </motion.div>
                      <motion.p
                        initial={{ opacity: 0 }}
                        ...
                        className="text-encre text-sm font-normal leading-relaxed mb-6">
                      ...
                      <div className="space-y-4">
                        <motion.div
                          ...
                          className="p-4 rounded-lg bg-fond/50 border border-trait">

                          <div className="flex items-center gap-2 mb-2">
                            <div className="w-3 h-3 rounded-full bg-menthe"></div>
                            <span className="text-xs text-encre font-normal uppercase tracking-wider">Courbe verte • Patrimoine net</span>
                          </div>
                          <p className="text-xs text-encre font-normal leading-relaxed">
                        ...
                        <motion.div
                          ...
                          <div className="flex items-center gap-2 mb-2">
                            <div className="w-3 h-3 rounded-full bg-red-400"></div>
                            <span className="text-xs text-encre font-normal uppercase tracking-wider">Courbe rouge • Dette restante</span>
                          </div>
                          <p className="text-xs text-encre font-normal leading-relaxed">
                    ...
                    <div className="relative bg-surface border border-encre/[0.12] p-6">
                      ...
                      <div className="space-y-4">
                        <motion.div
                          ...
                          <div className="flex items-center gap-2 mb-2">
                            <div className="w-3 h-3 rounded-full bg-menthe"></div>
                            <span className="text-xs text-encre font-normal uppercase tracking-wider">Phase 1-20 • Construction</span>
                          </div>
                          <p className="text-xs text-encre font-normal leading-relaxed">
                        ...
                        <motion.div
                          ...
                          <div className="flex items-center gap-2 mb-2">
                            <div className="w-3 h-3 rounded-full bg-menthe-clair"></div>
                            <span className="text-xs text-encre font-normal uppercase tracking-wider">Phase 20-30 • Liberté financière</span>
                          </div>
                          <p className="text-xs text-encre font-normal leading-relaxed">
    ...
    <div className="space-y-8 max-w-md">
      <div>
        <h2 className="text-[38px] md:text-[50px] font-light tracking-[-0.02em] leading-[1.08] mb-4">
          <span className="text-encre">Configurez. Planifiez.</span><br />
          <span className="text-menthe font-light">Investissez.</span>
        </h2>
        <p className="text-encre text-base font-normal ">
      ...
      {/* Stats cards */}
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-fond/50 border border-trait rounded-md p-6 text-center">
          <div className="mb-3 flex justify-center">
            <TrendingUp className="w-8 h-8 text-encre" />
          </div>
          <div className="text-encre font-semibold text-base mb-1 font-normal">Patrimoine net</div>
          <div className="text-xs text-ardoise font-normal">Évolution sur 30 ans</div>
        </div>
        <div className="bg-fond/50 border border-trait rounded-md p-6 text-center">
          <div className="mb-3 flex justify-center">
            <DollarSign className="w-8 h-8 text-encre" />
          </div>
          <div className="text-encre font-semibold text-base mb-1 font-normal">Cashflow annuel</div>
          <div className="text-xs text-ardoise font-normal">Projection détaillée</div>
        </div>
      </div>
    </div>
        ...
        <div className="relative bg-surface p-6 md:p-8">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-3">
              <span className="text-xs text-ardoise font-normal uppercase tracking-wider">Étape {currentStep} sur 4</span>
              <span className="text-xs text-menthe font-medium">{Math.round(currentStep / 4 * 100)}%</span>
            </div>
            <div className="h-1.5 bg-surface rounded-full overflow-hidden">
              <motion.div
                        className="h-full bg-gradient-to-r from-menthe to-menthe-clair"
                        initial={{ width: 0 }}
          ...
          <AnimatePresence mode="wait">
            ...
            {currentStep === 1 &&
                ...
                <h3 className="text-2xl text-encre font-medium mb-3">
                  Parlez-nous de vous
                </h3>
                <p className="text-encre text-sm mb-8 font-normal">
                  Commençons par quelques informations de base pour personnaliser votre stratégie.
                </p>

                <div className="space-y-6">
                  <div>
                    <Label className="text-sm text-encre mb-3 block font-normal">Quel est votre âge ?</Label>
                    <input
                            type="number"
                            value={age}
                            onChange={(e) => setAge(e.target.value)}
                            placeholder="Ex: 35"
                            className="w-full h-14 px-5 rounded-md bg-fond/50 border-2 border-trait hover:border-menthe focus:border-menthe text-encre text-lg font-normal transition-colors outline-none" />

                  </div>

                  <div>
                    <Label className="text-sm text-encre mb-3 block font-normal">Vous investissez...</Label>
                ...
                <div className="space-y-4">
                  {[
                        ...
                        <button
                          ...
                          'bg-menthe/10 border-menthe' :
                          'bg-fond/30 border-trait hover:border-bord'}`
                          }>

                      <div className="flex items-start gap-4">
                        <div className={`mt-1 w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                            objectif === option.value ? 'border-menthe' : 'border-bord'}`
                            }>
                          {objectif === option.value && <div className="w-3 h-3 rounded-full bg-menthe" />}
                        </div>
                        <div>
                          <div className={`font-medium mb-1 ${
                              objectif === option.value ? 'text-encre' : 'text-craie'}`
                              }>
                            {option.label}
                          </div>
                          <div className="text-sm text-encre/70 font-normal">{option.desc}</div>
                        </div>
                      </div>
                    </button>
                        )}
                ...
                <div className="space-y-4">
                  {[
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-start gap-4">
                          <div className={`mt-1 w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                              typeStrategie === option.value ? 'border-menthe' : 'border-bord'}`
                              }>
                            {typeStrategie === option.value && <div className="w-3 h-3 rounded-full bg-menthe" />}
                          </div>
                          <div>
                            <div className={`font-medium mb-1 ${
                                typeStrategie === option.value ? 'text-encre' : 'text-craie'}`
                                }>
                              {option.label}
                            </div>
                            <div className="text-sm text-encre/70 font-normal">{option.desc}</div>
                        ...
                        <div className={`text-2xl font-bold font-normal ${
                            typeStrategie === option.value ? 'text-menthe' : 'text-brume'}`
                            }>
                          {option.rate}
                        </div>
                      </div>
            ...
            {currentStep === 4 &&
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div>
                      <Label className="text-sm text-encre mb-3 block font-normal">Nombre de projets</Label>
                      <div className="flex items-center gap-3">
                        <Button
                                variant="outline"
                                size="icon"
                                ...
                                className="h-10 w-10 bg-fond/50 border-2 border-trait text-encre hover:bg-fond disabled:opacity-30">

                          <span className="text-lg">-</span>
                        </Button>
                        <div className="flex-1 text-center border-2 rounded-lg py-2 px-3 bg-fond/30 border-trait">
                          <span className="text-xl font-bold text-encre font-normal">{projets.length}</span>
                        </div>
                        <Button
                                variant="outline"
                                size="icon"
                    ...
                    <div>
                      <Label className="text-sm text-encre mb-3 block font-normal">Fréquence d'acquisition</Label>
                      <div className="grid grid-cols-3 gap-3">
                        {[
                ...
                <div className="h-fit">
                  <Label className="text-xs uppercase tracking-wider mb-4 block text-encre font-normal">
                      ...
                      {projets.map((projet, index) =>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <Select
                              ...
                              <SelectTrigger className="h-8 text-xs bg-fond/50 text-encre border-trait font-normal">
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent>
                          ...
                          <Button
                            ...
                            className="h-7 w-7 text-menthe hover:bg-menthe/10 shrink-0"
          ...
          {/* Navigation Buttons */}
          <div className="flex items-center justify-between mt-10 pt-6 border-t border-trait">
            {currentStep > 1 ?
                    <Button
                      onClick={() => setCurrentStep(currentStep - 1)}
                      variant="outline"
                      className="h-12 px-6 bg-fond/50 border-trait text-encre hover:bg-fond font-normal">
            ...
            {currentStep < 4 ?
                ...
                Continuer
                    ...
                    <Button
                      ...
                      className="h-12 px-8 bg-menthe hover:bg-[#e5a968] text-black font-medium rounded-full shadow-lg hover:scale-105 transition-all">
