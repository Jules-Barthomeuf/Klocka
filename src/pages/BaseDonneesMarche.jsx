...
export default function BaseDonneesMarche() {
  ...
  return (
    <div className="min-h-screen bg-fond p-3 md:p-10">
            ...
            <CardContent className="p-4 md:p-6">
              <div className="flex flex-col md:flex-row gap-3 md:gap-4">
                <div className="relative flex-1">
                  <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-ardoise w-4 h-4 md:w-5 md:h-5" />
                  <Input
        ...
        <div className="grid gap-3 md:gap-4">
                  ...
                  <div className="flex flex-col md:flex-row justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-start gap-3 mb-4">
                        <div className="w-10 h-10 bg-menthe/20 rounded-lg flex items-center justify-center flex-shrink-0">
                          <MapPin className="w-5 h-5 text-menthe" />
                        </div>
                        <div>
                          <h3 className="text-encre text-lg font-semibold">{item.ville}</h3>
                          {item.secteur && <p className="text-ardoise text-sm">{item.secteur}</p>}
                          {item.code_postal && (
                            <Badge className="mt-1 bg-bord text-craie text-xs">
                              {item.code_postal}
                            </Badge>
                          )}
                        </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
                        {item.prix_m2_median && (
                          <div className="bg-fond/50 rounded-lg p-3">
                            <p className="text-ardoise text-xs mb-1">Prix médian</p>
                            <p className="text-encre font-semibold">{item.prix_m2_median} €/m²</p>
                          </div>
                        )}
                        {item.prix_m2_bas && (
                          <div className="bg-fond/50 rounded-lg p-3">
                            <p className="text-ardoise text-xs mb-1">Prix bas</p>
                            <p className="text-encre font-semibold">{item.prix_m2_bas} €/m²</p>
                          </div>
                        )}
                        {item.prix_m2_haut && (
                          <div className="bg-fond/50 rounded-lg p-3">
                            <p className="text-ardoise text-xs mb-1">Prix haut</p>
                            <p className="text-encre font-semibold">{item.prix_m2_haut} €/m²</p>
                          </div>
                        )}
                        {item.evolution_1an !== null && item.evolution_1an !== undefined && (
                          <div className="bg-fond/50 rounded-lg p-3">
                            <p className="text-ardoise text-xs mb-1">Évolution 1 an</p>
                            <p className={`font-semibold ${item.evolution_1an >= 0 ? 'text-menthe' : 'text-red-500'}`}>
                        ...
                        {item.offre_moyenne && (
                          <div className="bg-fond/50 rounded-lg p-3">
                            <p className="text-ardoise text-xs mb-1">Loyer offre moy.</p>
                            <p className="text-encre font-semibold">{item.offre_moyenne} €/m²/an</p>
                          </div>
                        )}
                        {item.baux_moyenne && (
                          <div className="bg-fond/50 rounded-lg p-3">
                            <p className="text-ardoise text-xs mb-1">Baux constatés moy.</p>
                            <p className="text-encre font-semibold">{item.baux_moyenne} €/m²/an</p>
                          </div>
                        )}
                      </div>
                      ...
                      {item.description_marche && (
                        <p className="text-craie text-sm mb-2">{item.description_marche}</p>
                      )}

                      {/* Meta */}
                      <div className="flex flex-wrap gap-2 text-xs text-ardoise">
                    ...
                    <div className="flex md:flex-col gap-2">
                      <Button
                        ...
                        className="text-menthe hover:bg-menthe/10 h-9 w-9"
                      >
          ...
          {filteredData.length === 0 && (
            <div className="text-center py-12 md:py-20">
              <Database className="w-16 h-16 md:w-20 md:h-20 text-brume mx-auto mb-4 md:mb-6" />
              <h2 className="text-xl md:text-2xl text-encre mb-2 md:mb-3">
                Aucune donnée de marché
              </h2>
              <p className="text-ardoise max-w-md mx-auto text-sm md:text-base px-4 mb-6">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="bg-fond border-bord max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            {/* Localisation */}
            <div className="p-4 bg-menthe/10 border border-menthe/30 rounded-lg space-y-4">
              <h4 className="text-menthe font-medium">Localisation</h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label className="text-ardoise text-sm">Ville *</Label>
                  <Input
                ...
                <div>
                  <Label className="text-ardoise text-sm">Secteur/Quartier</Label>
                  <Input
                ...
                <div>
                  <Label className="text-ardoise text-sm">Code postal</Label>
                  <Input
            ...
            <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label className="text-ardoise text-sm">Prix médian (€/m²)</Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label className="text-ardoise text-sm">Prix bas (€/m²)</Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label className="text-ardoise text-sm">Prix haut (€/m²)</Label>
                  <Input
                    type="number"
            ...
            {/* Évolution */}
            <div className="p-4 bg-menthe/10 border border-menthe/30 rounded-lg space-y-4">
              <h4 className="text-menthe-clair font-medium">Évolution du marché</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label className="text-ardoise text-sm">Évolution 1 an (%)</Label>
                  <Input
                    type="number"
                    step="0.1"
                ...
                <div>
                  <Label className="text-ardoise text-sm">Évolution 5 ans (%)</Label>
                  <Input
                    type="number"
                    step="0.1"
            ...
            <div className="p-4 bg-purple-500/10 border border-purple-500/30 rounded-lg space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label className="text-ardoise text-sm">Bas</Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label className="text-ardoise text-sm">Moyen</Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label className="text-ardoise text-sm">Haut</Label>
                  <Input
                    type="number"
            ...
            <div className="space-y-4">
              <div>
                <Label className="text-ardoise text-sm">Description du marché</Label>
                <Textarea
              ...
              <div>
                <Label className="text-ardoise text-sm">Notes complémentaires</Label>
                <Textarea
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label className="text-ardoise text-sm">Source des données</Label>
                  <Input
                ...
                <div>
                  <Label className="text-ardoise text-sm">Date de mise à jour</Label>
                  <Input
                    type="date"
