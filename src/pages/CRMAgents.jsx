                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-gray-600">
                        ...
                        <th className="text-left py-3 px-3 text-gray-300 font-semibold whitespace-nowrap border-r border-gray-700 min-w-[200px]">Personnes</th>
                        ...
                        <th className="text-left py-3 px-3 text-gray-300 font-semibold whitespace-nowrap border-r border-gray-700 min-w-[400px]">Propriétés</th>
                    ...
                    <tbody>
                      {contacts.map((contact) => (
                        <tr key={contact.id} className="border-b border-gray-600 hover:bg-gray-700/30 transition-colors">
                          ...
                          <td className="py-3 px-3 border-r border-gray-600 min-w-[400px]">
