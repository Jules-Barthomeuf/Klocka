              ...
              {categoryResources.map((resource) => {
                ...
                return (
                  <div key={resource.id} className="relative rounded-[1.25rem] border-[0.75px] border-gray-700 p-2">
                    ...
                    <Card 
                      className="relative bg-gradient-to-br from-gray-900/95 via-[#2A9D8F]/5 to-gray-900/95 hover:opacity-90 transition-all cursor-pointer border-none"
                      onClick={() => resource.url_fichier && window.open(resource.url_fichier, '_blank')}
                    >
                      <CardContent className="p-6">
                        <div className="flex items-start gap-4 mb-4">
                          <div className="w-12 h-12 bg-[#2A9D8F]/20 rounded-lg flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex items-center justify-end mt-4">
                          <ExternalLink className="w-4 h-4 text-[#2A9D8F]" />
                        </div>
                      </CardContent>
                    </Card>
                  </div>
