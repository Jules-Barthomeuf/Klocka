...
export default function TableauProjection() {
  ...
  return (
    <div className="min-h-screen bg-neutral-900 p-2 md:p-6">
      <div className="w-full">
        <Card className="shadow-lg rounded-xl bg-gradient-to-br from-gray-900/95 via-[#2A9D8F]/5 to-gray-900/95 border-gray-700">
          <CardHeader>
            ...
            <div className="overflow-x-auto overflow-y-auto max-h-[85vh]">
              <table className="w-full text-xs border-collapse">
                <thead className="sticky top-0 z-20">
                  <tr className="border-b-2 border-[#2A9D8F] bg-gray-800 shadow-sm">
                    <th className={`sticky left-0 z-30 bg-gray-800 px-3 py-2 text-left font-semibold border-r border-[#2A9D8F] text-white min-w-[200px]`}></th>
                ...
                <tbody className="divide-y divide-gray-700 bg-gray-800">
                  ...
                  <tr className="bg-blue-900/10 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => toggleSection('loyers')}>
                    <td className={`px-3 py-1.5 font-medium ${textClass} text-xs sticky left-0 z-10 bg-blue-900/30 border-r border-[#2A9D8F] min-w-[200px]`}>
                  ...
                  {!expandedSections.loyers && (
                    <tr className="font-medium">
                      <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Total</td>
                      {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                  ...
                  {expandedSections.loyers && (
                    <>
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Loyers annuels bruts HT HC</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Vacance locative (mois)</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Coût de la vacance locative</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Charges de copropriété</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Taxe Foncière</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr className="font-medium bg-gray-900">
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-900 border-r border-[#2A9D8F] min-w-[200px]`}>Loyers annuels nets</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                          <td key={row.annee} className={`px-2 py-1.5 text-center text-[#2A9D8F] ${row.annee > anneeRevente ? 'bg-gray-700/30' : ''}`}>{formatCurrency(row.loyersNets)}</td>
                        ))}
                      </tr>
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Rendement Locatif net</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                  ...
                  <tr className="bg-purple-900/10 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => toggleSection('credit')}>
                    <td className={`px-3 py-1.5 font-medium ${textClass} text-xs sticky left-0 z-10 bg-purple-900/30 border-r border-[#2A9D8F] min-w-[200px]`}>
                  ...
                  {expandedSections.credit && (
                    <>
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Intérêts</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Capital remboursé</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Échéance annuelle crédit</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Capital restant dû</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>IRA (Indemnité remb. anticipé)</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Assurance crédit</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                  ...
                  <tr className="bg-yellow-900/10 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => toggleSection('charges_exploitation')}>
                    <td className={`px-3 py-1.5 font-medium ${textClass} text-xs sticky left-0 z-10 bg-yellow-900/30 border-r border-[#2A9D8F] min-w-[200px]`}>
                  ...
                  {expandedSections.charges_exploitation && (
                    <>
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Gestion locative</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Charges liées à l'acquisition</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Travaux bailleur</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Comptabilité</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Assurance PNE</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Charges diverses</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                  ...
                  <tr className="bg-red-900/10 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => toggleSection('fiscalite')}>
                    <td className={`px-3 py-1.5 font-medium ${textClass} text-xs sticky left-0 z-10 bg-red-900/30 border-r border-[#2A9D8F] min-w-[200px]`}>
                  ...
                  {expandedSections.fiscalite && (
                    <>
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Amortissement</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      ...
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Bénéfice imposable</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                          <td key={row.annee} className={`px-2 py-1.5 text-center ${row.beneficeImposable > 0 ? 'text-green-600' : 'text-red-600'} ${row.annee > anneeRevente ? 'bg-gray-700/30' : ''}`}>
                            {formatCurrency(row.beneficeImposable)}
                          </td>
                        ))}
                      </tr>
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Impôt 15% du bénéfice</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                  ...
                  <tr className="bg-indigo-900/10 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => toggleSection('tva')}>
                    <td className={`px-3 py-1.5 font-medium ${textClass} text-xs sticky left-0 z-10 bg-indigo-900/30 border-r border-[#2A9D8F] min-w-[200px]`}>
                  ...
                  {!expandedSections.tva && (
                    <tr className="font-medium">
                      ...
                      {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => {
                        ...
                        return (
                          <td key={row.annee} className={`px-2 py-1.5 text-center ${tresorerieTVAValue > 0 ? 'text-green-600' : tresorerieTVAValue < 0 ? 'text-red-600' : mutedClass} ${row.annee > anneeRevente ? 'bg-gray-700/30' : ''}`}>
                  ...
                  {expandedSections.tva && (
                    <>
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>TVA collectée</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                          <td key={row.annee} className={`px-2 py-1.5 text-center ${row.tvaCollectee > 0 ? 'text-green-600' : mutedClass} ${row.annee > anneeRevente ? 'bg-gray-700/30' : ''}`}>
                            {row.tvaCollectee > 0 ? formatCurrency(row.tvaCollectee) : '-'}
                          </td>
                        ))}
                      </tr>
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>TVA déductible</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                          <td key={row.annee} className={`px-2 py-1.5 text-center ${row.tvaDeductible > 0 ? 'text-green-600' : mutedClass} ${row.annee > anneeRevente ? 'bg-gray-700/30' : ''}`}>
                            {row.tvaDeductible > 0 ? formatCurrency(row.tvaDeductible) : '-'}
                          </td>
                        ))}
                      </tr>
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Crédit de TVA</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                          <td key={row.annee} className={`px-2 py-1.5 text-center ${row.creditTVA > 0 ? 'text-green-600' : mutedClass} ${row.annee > anneeRevente ? 'bg-gray-700/30' : ''}`}>
                            {row.creditTVA !== 0 ? formatCurrency(row.creditTVA) : '-'}
                          </td>
                        ))}
                      </tr>
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Trésorerie de TVA</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => {
                          const tresorerieTVAValue = row.tresorerieTVACashFlow;
                          return (
                            <td key={row.annee} className={`px-2 py-1.5 text-center ${tresorerieTVAValue > 0 ? 'text-green-600' : tresorerieTVAValue < 0 ? 'text-red-600' : mutedClass} ${row.annee > anneeRevente ? 'bg-gray-700/30' : ''}`}>
                  ...
                  <tr className="bg-teal-900/10 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => toggleSection('cashflow')}>
                    <td className={`px-3 py-1.5 font-medium ${textClass} text-xs sticky left-0 z-10 bg-teal-900/30 border-r border-[#2A9D8F] min-w-[200px]`}>
                  ...
                  <tr className="font-medium bg-gray-900">
                    <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-900 border-r border-[#2A9D8F] min-w-[200px]`}>Cash flow / an</td>
                    {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                      <td key={row.annee} className={`px-2 py-1.5 text-center ${row.cashFlowAnnuel >= 0 ? 'text-green-600' : 'text-red-600'} ${row.annee > anneeRevente ? 'bg-gray-700/30' : ''}`}>
                  ...
                  {expandedSections.cashflow && (
                    <>
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Cash flow / mois</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
                          <td key={row.annee} className={`px-2 py-1.5 text-center ${row.cashFlowMensuel >= 0 ? 'text-green-600' : 'text-red-600'} ${row.annee > anneeRevente ? 'bg-gray-700/30' : ''}`}>
                            {formatCurrency(row.cashFlowMensuel)}
                          </td>
                        ))}
                      </tr>
                      <tr>
                        <td className={`px-3 py-1.5 ${textClass} sticky left-0 z-10 bg-gray-800 border-r border-[#2A9D8F] min-w-[200px]`}>Capital remboursé cumulé</td>
                        {tableauAnnuel.slice(1, Math.min(anneeRevente + 6, 26)).map((row) => (
