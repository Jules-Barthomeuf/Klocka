...
export default function AdminSignup() {
  ...
  if (isChecking) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-encre flex items-center justify-center">
  ...
  if (!hasValidToken) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-encre flex items-center justify-center p-4">
        <Card className="max-w-md w-full border-none shadow-2xl">
          <CardHeader className="bg-gradient-to-r from-red-500 to-red-600 text-encre pb-8">
            <div className="flex items-center justify-center mb-4">
              <div className="w-16 h-16 bg-encre/20 rounded-full flex items-center justify-center">
                <AlertCircle className="w-8 h-8 text-encre" />
              </div>
            </div>
          ...
          <CardContent className="p-8 text-center space-y-6">
            <div>
              <h2 className="text-xl font-semibold text-fond mb-2">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-encre flex items-center justify-center p-4">
      <Card className="max-w-md w-full border-none shadow-2xl">
        <CardHeader className="bg-gradient-to-r from-[#1f2423] to-bord-doux text-encre pb-8">
          <div className="flex items-center justify-center mb-4">
            <div className="w-16 h-16 bg-encre/20 rounded-full flex items-center justify-center">
              <Shield className="w-8 h-8 text-encre" />
            </div>
          </div>
          <CardTitle className="text-3xl font-montserrat text-center">
        ...
        <CardContent className="p-8 text-center space-y-6">
          ...
          <Button
            onClick={handleLogin}
            className="w-full h-12 bg-[#1f2423] text-encre hover:bg-bord"
          >
