          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif" }} className="text-4xl md:text-5xl lg:text-6xl leading-[1.1] mb-4 text-white font-medium">
                Votre plateforme tout en un en <span className="text-[#2A9D8F]">immobilier commercial.</span>
              </h1>
            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden border border-white/[0.08] shadow-2xl bg-gradient-to-br from-white/[0.03] to-transparent">
                <img
              ...
              <div className="absolute -bottom-6 -left-6 bg-neutral-800 backdrop-blur border border-white/15 rounded-2xl px-6 py-5 shadow-2xl">
                <p className="text-3xl font-bold text-[#2A9D8F]">7–9%</p>
                <p className="text-xs text-gray-400 uppercase tracking-widest mt-1">Rendement moyen</p>
              </div>
              {/* Floating card - Plateforme */}
              <div className="absolute -top-4 -right-4 bg-neutral-800 backdrop-blur border border-white/15 rounded-xl px-4 py-3 shadow-2xl">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-[#2A9D8F]/20 flex items-center justify-center">
