      ...
      {place && (
        ...
        >
          ...
          <textarea
            ...
            className="w-full resize-none rounded-[10px] border border-bord bg-fond px-3 py-2.5 text-[13.5px] text-encre outline-none transition-colors placeholder:text-brume focus:border-menthe"
          />
