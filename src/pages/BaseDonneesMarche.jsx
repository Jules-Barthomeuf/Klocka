...
export default function BaseDonneesMarche() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0c0c] p-3 md:p-10">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 md:mb-8">
          <h1 className="text-2xl md:text-4xl font-montserrat text-[#edeae5] mb-2">
            Base de Données Marché
          </h1>
          <div className="h-0.5 w-24 md:w-32 bg-[#35a79b] mb-2"></div>
          <p className="text-[#9aa19e] text-sm md:text-lg">
            Gérez les données de marché pour l'auto-complétion des projets
          </p>
        </div>

        {/* Barre de recherche et bouton ajouter */}
        <div className="relative rounded-[1.25rem] border-[0.75px] border-[#303332] p-2 md:rounded-[1.5rem] md:p-3 mb-4 md:mb-6">
          <GlowingEffect spread={40} glow={true} disabled={false} proximity={64} inactiveZone={0.01} borderWidth={3} />
          <Card className="relative bg-gradient-to-br from-[#303332]/80 to-[#171918] border-none">
            <CardContent className="p-4 md:p-6">
              <div className="flex flex-col md:flex-row gap-3 md:gap-4">
                <div className="relative flex-1">
                  <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#9aa19e] w-4 h-4 md:w-5 md:h-5" />
                  <Input
                    placeholder="Rechercher par ville, secteur ou code postal..."
                    value={searchTerm}
                    onChange={(e) => setSearchTerm(e.target.value)}
                    className="pl-10 h-10 md:h-12 text-sm md:text-base bg-[#0a0c0c] text-[#edeae5] border-[#303332]"
                  />
                </div>
                <Button
                  onClick={() => handleOpenDialog()}
                  className="bg-[#35a79b] hover:bg-[#35a79b]/90 text-[#edeae5] h-10 md:h-12"
                >
        ...
        <div className="grid gap-3 md:gap-4">
          {filteredData.map((item) => (
            <div key={item.id} className="relative rounded-[1.25rem] border-[0.75px] border-[#303332] p-2 md:rounded-[1.5rem] md:p-3">
              <GlowingEffect spread={40} glow={true} disabled={false} proximity={64} inactiveZone={0.01} borderWidth={3} />
              <Card className="relative bg-gradient-to-br from-[#303332]/80 to-[#171918] border-none">
                <CardContent className="p-4 md:p-6">
                  <div className="flex flex-col md:flex-row justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-start gap-3 mb-4">
                        <div className="w-10 h-10 bg-[#35a79b]/20 rounded-lg flex items-center justify-center flex-shrink-0">
                          <MapPin className="w-5 h-5 text-[#35a79b]" />
                        </div>
                        <div>
                          <h3 className="text-[#edeae5] text-lg font-semibold">{item.ville}</h3>
                          {item.secteur && <p className="text-[#9aa19e] text-sm">{item.secteur}</p>}
                          {item.code_postal && (
                            <Badge className="mt-1 bg-[#303332] text-[#d3d8d6] text-xs">
                              {item.code_postal}
                            </Badge>
                          )}
                        </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
                        {item.prix_m2_median && (
                          <div className="bg-[#0a0c0c]/50 rounded-lg p-3">
                            <p className="text-[#9aa19e] text-xs mb-1">Prix médian</p>
                            <p className="text-[#edeae5] font-semibold">{item.prix_m2_median} €/m²</p>
                          </div>
                        )}
                        {item.prix_m2_bas && (
                          <div className="bg-[#0a0c0c]/50 rounded-lg p-3">
                            <p className="text-[#9aa19e] text-xs mb-1">Prix bas</p>
                            <p className="text-[#edeae5] font-semibold">{item.prix_m2_bas} €/m²</p>
                          </div>
                        )}
                        {item.prix_m2_haut && (
                          <div className="bg-[#0a0c0c]/50 rounded-lg p-3">
                            <p className="text-[#9aa19e] text-xs mb-1">Prix haut</p>
                            <p className="text-[#edeae5] font-semibold">{item.prix_m2_haut} €/m²</p>
                          </div>
                        )}
                        {item.evolution_1an !== null && item.evolution_1an !== undefined && (
                          <div className="bg-[#0a0c0c]/50 rounded-lg p-3">
                            <p className="text-[#9aa19e] text-xs mb-1">Évolution 1 an</p>
                            <p className={`font-semibold ${item.evolution_1an >= 0 ? 'text-[#35a79b]' : 'text-red-500'}`}>
                        ...
                        {item.offre_moyenne && (
                          <div className="bg-[#0a0c0c]/50 rounded-lg p-3">
                            <p className="text-[#9aa19e] text-xs mb-1">Loyer offre moy.</p>
                            <p className="text-[#edeae5] font-semibold">{item.offre_moyenne} €/m²/an</p>
                          </div>
                        )}
                        {item.baux_moyenne && (
                          <div className="bg-[#0a0c0c]/50 rounded-lg p-3">
                            <p className="text-[#9aa19e] text-xs mb-1">Baux constatés moy.</p>
                            <p className="text-[#edeae5] font-semibold">{item.baux_moyenne} €/m²/an</p>
                          </div>
                        )}
                      </div>
                      ...
                      {item.description_marche && (
                        <p className="text-[#d3d8d6] text-sm mb-2">{item.description_marche}</p>
                      )}

                      {/* Meta */}
                      <div className="flex flex-wrap gap-2 text-xs text-[#8b9391]">
                    ...
                    <div className="flex md:flex-col gap-2">
                      <Button
                        ...
                        className="text-[#35a79b] hover:bg-[#35a79b]/10 h-9 w-9"
                      >
          ...
          {filteredData.length === 0 && (
            <div className="text-center py-12 md:py-20">
              <Database className="w-16 h-16 md:w-20 md:h-20 text-[#6b7270] mx-auto mb-4 md:mb-6" />
              <h2 className="text-xl md:text-2xl text-[#edeae5] mb-2 md:mb-3">
                Aucune donnée de marché
              </h2>
              <p className="text-[#9aa19e] max-w-md mx-auto text-sm md:text-base px-4 mb-6">
                {searchTerm ? "Aucun résultat pour cette recherche" : "Commencez par ajouter des données de marché"}
              </p>
              {!searchTerm && (
                <Button
                  onClick={() => handleOpenDialog()}
                  className="bg-[#35a79b] hover:bg-[#35a79b]/90 text-[#edeae5]"
                >
                  <Plus className="w-4 h-4 mr-2" />
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="bg-[#0a0c0c] border-[#303332] max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-[#edeae5] flex items-center gap-2">
              <Database className="w-5 h-5 text-[#35a79b]" />
          ...
          <div className="space-y-6">
            {/* Localisation */}
            <div className="p-4 bg-[#35a79b]/10 border border-[#35a79b]/30 rounded-lg space-y-4">
              <h4 className="text-[#35a79b] font-medium">Localisation</h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label className="text-[#9aa19e] text-sm">Ville *</Label>
                  <Input
                ...
                <div>
                  <Label className="text-[#9aa19e] text-sm">Secteur/Quartier</Label>
                  <Input
                ...
                <div>
                  <Label className="text-[#9aa19e] text-sm">Code postal</Label>
                  <Input
            ...
            <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label className="text-[#9aa19e] text-sm">Prix médian (€/m²)</Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label className="text-[#9aa19e] text-sm">Prix bas (€/m²)</Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label className="text-[#9aa19e] text-sm">Prix haut (€/m²)</Label>
                  <Input
                    type="number"
            ...
            {/* Évolution */}
            <div className="p-4 bg-[#35a79b]/10 border border-[#35a79b]/30 rounded-lg space-y-4">
              <h4 className="text-[#7fd3c9] font-medium">Évolution du marché</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label className="text-[#9aa19e] text-sm">Évolution 1 an (%)</Label>
                  <Input
                    type="number"
                    step="0.1"
                ...
                <div>
                  <Label className="text-[#9aa19e] text-sm">Évolution 5 ans (%)</Label>
                  <Input
                    type="number"
                    step="0.1"
            ...
            <div className="p-4 bg-purple-500/10 border border-purple-500/30 rounded-lg space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label className="text-[#9aa19e] text-sm">Bas</Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label className="text-[#9aa19e] text-sm">Moyen</Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label className="text-[#9aa19e] text-sm">Haut</Label>
                  <Input
                    type="number"
            ...
            <div className="space-y-4">
              <div>
                <Label className="text-[#9aa19e] text-sm">Description du marché</Label>
                <Textarea
              ...
              <div>
                <Label className="text-[#9aa19e] text-sm">Notes complémentaires</Label>
                <Textarea
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label className="text-[#9aa19e] text-sm">Source des données</Label>
                  <Input
                ...
                <div>
                  <Label className="text-[#9aa19e] text-sm">Date de mise à jour</Label>
                  <Input
                    type="date"
