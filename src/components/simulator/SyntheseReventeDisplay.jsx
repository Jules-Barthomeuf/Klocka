  ...
  return (
    <div className="bg-[#0a0c0c] p-4 rounded-md md:p-6 border border-[#edeae5]/[0.1] max-w-full overflow-hidden">
      <div className="flex flex-col md:flex-row md:items-baseline gap-1 md:gap-3 mb-3 md:mb-4">
        <h3 className="font-light text-[#edeae5] text-xl md:text-2xl tracking-tight">Synthèse à la revente</h3>
        <span className="text-xs text-[#edeae5]/50">année {anneeRevente}</span>
      </div>
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 md:gap-4 w-full mb-4 md:mb-6">
        <div className="p-2 md:p-4 rounded-md bg-[#edeae5]/[0.04] border border-[#282b2a] flex flex-col items-center justify-center text-center">
        ...
        <div className="p-2 md:p-4 rounded-md bg-[#edeae5]/[0.04] border border-[#282b2a] flex flex-col items-center justify-center text-center">
          ...
          <p className={`text-sm md:text-lg font-medium tabular-nums ${calculs.indicateurs.cashFlowCumule >= 0 ? 'text-[#35a79b]' : 'text-red-500'}`}>{formatCurrency(calculs.indicateurs.cashFlowCumule)}</p>
        </div>
        <div className="p-2 md:p-4 rounded-md bg-gradient-to-r from-[#D4AF37]/20 to-[#F5D76E]/20 border border-[#D4AF37]/50 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-xs text-[#edeae5]/50 mt-1">x{calculs.indicateurs.multipleNetFondsPropres}</p>
        </div>
      </div>
        ...
        <ResponsiveContainer width="100%" height="100%">
          <BarChart
            data={[
              ...
              { name: 'Prix revente net', value: calculs.revente.prixVenteNet, fill: '#7fd3c9' },
