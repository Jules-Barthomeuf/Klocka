...
export default function AdminProjets() {
  ...
  const resetForm = () => {
    ...
    setFormData({
      ...
      sim_taux_interet: 3.9, sim_taux_assurance: 0.25, sim_apport: 0, sim_total_financement: 0,
  ...
  const handleEdit = (project) => {
    ...
    setFormData({
      ...
      sim_taux_interet: project.sim_taux_interet ?? 3.9, sim_taux_assurance: project.sim_taux_assurance ?? 0.25,
  ...
  const construireDonnees = (currentFormData) => {
      ...
      const data = {
        ...
        sim_taux_interet: parseFloat(currentFormData.sim_taux_interet) || 3.9,
  ...
  return (
    <div className="projet-editorial relative min-h-screen bg-fond px-5 py-8 text-encre md:px-10 md:py-12">
      <FondHalo />
