...
export const CashflowChart = React.memo(function CashflowChart({ data }) {
  ...
  const maxValue = Math.max(...data.map((d) => d.cashflow));
  ...
  const generatePath = () => {
    const points = data.map((d, i) => ({ x: getX(i), y: getY(d.cashflow) }));
    ...
    <div className="relative">
      <div className="relative overflow-hidden p-6">
        <div className="mb-4 h-[72px]">
          <p className="text-sm font-medium text-gray-400">Cashflow annuel</p>
        ...
        <div className="relative">
          ...
          >
            ...
            <path d={generateAreaPath()} fill="url(#cashflowAreaGradient)" />
