  ...
  return (
    <div className="min-h-screen bg-[#0a0c0c] flex items-center justify-center p-8">
      <div className="bg-[#0a0c0c] border border-[#242726] rounded-md p-10 max-w-md w-full text-center space-y-6">
        ...
        <div>
          <h1 className="text-2xl font-light text-[#edeae5] mb-2">Export Clients</h1>
          <p className="text-[#8b9391] text-sm">Télécharge l'intégralité de l'entité User (clients) en JSON brut, tous champs inclus.</p>
        </div>
