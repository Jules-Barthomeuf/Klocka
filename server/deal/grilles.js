...
export const GRILLES = {
  bail: {
    ...
    criteres: [
      ...
      { id: 'charges', libelle: 'Charges refacturées', champs: ['charges', 'charges_copro'], format: "« OUI » ou « NON » ; si OUI, lister uniquement les charges refacturées au locataire. Ce qui reste au bailleur va dans « charges_bailleur », pas ici. N'oublie aucun poste mis au preneur, l'impôt foncier compris — le bail l'écrit aussi « taxe foncière », « impôts fonciers », « contributions et taxes », « charges fiscales » ou « TF ».", regle: 'Warning si les charges de copropriété ne peuvent pas être refacturées au locataire.' },
      ...
      { id: 'taxes', libelle: 'Taxes refacturées', champs: ['taxe_fonciere', 'charges'], format: "« OUI » ou « NON » ; si OUI, lister les taxes refacturées au locataire et celles restant au bailleur. L'impôt foncier est la taxe foncière : le bail l'écrit aussi « impôts fonciers », « contributions et taxes », « charges fiscales » ou « TF ».", regle: 'Warning si la taxe foncière ne peut pas être refacturée au locataire.' },
    ],
    schema: {
